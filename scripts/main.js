...
const translations = {
    fr: {
        ...
        'exp1-description': 'Développement d\'une application web de gestion documentaire et d\'administration avec Angular (frontend) et Django (backend). Authentification, gestion des rôles, upload de fichiers, gestion des utilisateurs et intégration d\'un chatbot IA.',
        'exp2-title': 'Développement Low-Code',
        'exp2-date': 'Juillet - Août 2024',
        'exp2-description': 'Développement d\'une application métier avec Joget DX 7 : formulaires, flux de travail, interfaces utilisateurs. Déploiement et tests mobiles via Joget Mobile App et Apache Cordova.',
        'projects-title': 'Mes Projets',
        'project1-title': 'Plateforme E-Learning et Gestion RH',
        'project1-description': 'Application web combinant e-learning et gestion RH avec gestion des offres d\'emploi, candidatures et planification automatique des entretiens. Architecture microservices.',
        'project2-title': 'Application Suivi Santé Multiplateforme',
    ...
    en: {
        ...
        'exp1-description': 'Development of a document management and administration web application with Angular (frontend) and Django (backend). Authentication, role management, file uploads, user management and AI chatbot integration.',
        'exp2-title': 'Low-Code Development',
        'exp2-date': 'July - August 2024',
        'exp2-description': 'Development of business application with Joget DX 7: forms, workflows, user interfaces. Mobile deployment and testing via Joget Mobile App and Apache Cordova.',
        'projects-title': 'My Projects',
        'project1-title': 'E-Learning & HR Management Platform',
        'project1-description': 'Web application combining e-learning and HR management with job offers management, applications and automatic interview scheduling. Microservices architecture.',
        'project2-title': 'Multi-Platform Health Tracking App',
